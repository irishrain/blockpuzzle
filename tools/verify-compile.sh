...
mkdir -p "$STUBS/androidx/annotation" "$STUBS/androidx/appcompat/app" \
         "$STUBS/androidx/core/content" "$STUBS/de/mwvb/blockpuzzle" \
         "$STUBS/de/mwvb/blockpuzzle/databinding"
...
# ViewBinding stub for activity_main, generated by AGP from res/layout/activity_main.xml.
cat > "$STUBS/de/mwvb/blockpuzzle/databinding/ActivityMainBinding.java" <<'EOF'
package de.mwvb.blockpuzzle.databinding;
...
public final class ActivityMainBinding {
    public final RelativeLayout placeholder1 = null;
    public final RelativeLayout placeholder2 = null;
    public final RelativeLayout placeholder3 = null;
    public final RelativeLayout parking = null;
    public final PlayingFieldView playingField = null;
    public final Button newGame = null;
    public final TextView info = null;
    public final TextView infoDisplay = null;
    public final TextView territoryName = null;
    public static ActivityMainBinding inflate(LayoutInflater inflater) { return new ActivityMainBinding(); }
    public RelativeLayout getRoot() { return null; }
}
EOF
...
find "$ROOT/app/src/main/java" "$ROOT/app/src/test/java" -name '*.kt'  > "$WORK/kt.list"
